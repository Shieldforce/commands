    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center px-4
        ...
        <div className="w-full max-w-sm text-center">
          <p className="text-sm text-red-600 dark:text-gh-red">
            Link inválido. Solicite um novo link de recuperação.
          </p>
          <Link to="/forgot-password"
            className="mt-4 inline-block text-sm text-blue-600 dark:text-gh-blue font-medium">
            Solicitar novo link
          </Link>
        </div>
      </div>
    ...
    <div className="min-h-screen flex flex-col items-center justify-center px-4
      ...
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-gray-500 dark:text-gh-muted mt-1">Redefinir senha</p>
        </div>
          ...
          <form onSubmit={submit} className="space-y-4">
            <div>
              <label className="block text-xs font-semibold uppercase tracking-wide
                text-gray-500 dark:text-gh-muted mb-1.5">Nova senha</label>
              <input
                type="password"
                required
                minLength={4}
